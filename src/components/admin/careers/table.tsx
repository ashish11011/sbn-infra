                        ...
                        careerData?.map((item: any, index: number) => {
                            ...
                            return (
                                <TableRow key={item.id}>
                                    ...
                                    <TableCell className="">{changeDataFormat(item.date_posted)}</TableCell>
                                    <TableCell className=' flex items-center gap-4' >
                                        <Trash2 onClick={() => handleDelete(item.id)} className=' text-gray-700 size-5 cursor-pointer' />
